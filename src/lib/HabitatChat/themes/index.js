export const defaultThemeStyles = {
  light: {
    ...
    header: {
      background: '#fff',
      colorChannelName: '#0a0a0a',
      colorChannelInfo: '#9ca6af'
    },
...
export const cssThemeVars = ({
  ...
  return {
    ...
    '--chat-header-color-name': header.colorChannelName,
    '--chat-header-color-info': header.colorChannelInfo,
    ...
    // channel
    '--chat-channel-color-username': channel.colorUsername,
    '--chat-channel-color-message': channel.colorMessage,
    '--chat-channel-color-timestamp': channel.colorTimestamp,
    '--chat-channel-color-online': channel.colorStateOnline,
    '--chat-channel-color-offline': channel.colorStateOffline,
    '--chat-channel-bg-color-badge': channel.backgroundCounterBadge,
    '--chat-channel-color-badge': channel.colorCounterBadge,
    ...
    '--chat-icon-color-dropdown-channel': icons.dropdownChannel,
